...
let projectsDisplayed = projectData
  if (listToDisplay === "mintbean"){
    projectsDisplayed = projectData.filter((project) => project.org === "Mintbean")
  ...
  return (
    <article>
      ...
      <div className="find_out_more_container"> <button type="button" className="find_out_more" onClick={() => setList("mintbean")}>Mintbean</button>
      <button type="button" className="find_out_more" onClick={() => setList("Solo")}>Solo</button>
      <button type="button" className="find_out_more" onClick={() => setList("team")}>Team</button>
      <button type="button" className="find_out_more" onClick={() => setList("")}>All</button>
        </div>
