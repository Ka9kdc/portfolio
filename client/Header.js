...
const Header = () => {
  ...
  return (
    <nav id="navbar" className="faded">
      ...
      <li className="logo"><h3 className="title">Kelsey Schroeder</h3></li>
      ...
      <li className="item"><NavLink to="/Skills">Skills</NavLink></li>
      <li className="toggle" onClick={(() => {setActive(!active)})} >
        {active ? <i className="fas fa-times"></i> : <i className="fas fa-bars"></i>}</li>
      </ul>
    </nav>
  );
};
