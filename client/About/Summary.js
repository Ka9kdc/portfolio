    ...
    <section id="Summary">
      ...
      <article className="faded">
        <p>
          ...
          challenge of updating her radio club's website, has fallen in love
          with web development. Now I am a full-stack developer specializing in
        ...
        <p>
          ...
          which I am running jobs on two copiers, printing posters, and binding
          a book all while faxing for the customer at my counter. My job at
          Office Depot greatly improved my ability to multitask. If I wasn't
        ...
        <p>
          ...
          tickets online and that we were stuck in the '90s with only accepting
        ...
        <p>
          ...
          try to keep the Hamfest page updated myself. Over the next week, I
          taught myself to code in HTML and basic PHP, and Javascript. By the
          end of the week, I found my new passion in life and had PayPal
          integrated into the site for attendees to place ticket orders online.
          When I lost my job and the pandemic hit a few months later. I took it
          as a sign to dive deeper into my newfound love of coding and web
          development.
        </p>
      </article>
    </section>
