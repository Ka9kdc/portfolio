...
describe('Education Component', () => {
    ...
    it('contains Institute component', () => {
      expect(
        container.containsMatchingElement([
          <Institute key={EducationData[0].place} />,
        ])
      ).to.equal(true);
    });
  });
  ...
  describe('institute component', () => {
    ...
    it('should include two logos', () => {
      ...
      expect(logos.at(0).getElement().props.src).to.equal(
        EducationData[0].images[0].src
      );
      expect(logos.at(0).getElement().props.alt).to.equal(
        EducationData[0].images[0].alt
      );
      expect(logos.at(1).getElement().props.src).to.equal(
        EducationData[0].images[1].src
      );
      expect(logos.at(1).getElement().props.alt).to.equal(
    ...
    it('should contain paragraphs about the institution', () => {
      ...
      expect(description.at(0).text()).to.equal(
        EducationData[0].description[0]
      );
    });
  });
